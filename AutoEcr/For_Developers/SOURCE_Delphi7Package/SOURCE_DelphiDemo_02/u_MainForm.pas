...
begin
	...
	try
		...
		if (CompareDateTime(end_Date, start_Date) <= 0) then
		begin
...
begin
	try
		...
		ShowMessage('Received documents: ' + IntToStr(receivedDocuments));
	finally
...
begin
	...
	try
		...
		ShowMessage('Printed documents count: ' + IntToStr(printedDocumentsCount));
	finally
