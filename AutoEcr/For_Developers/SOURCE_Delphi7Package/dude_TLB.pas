...
// PASTLWTR : 1.2
// File generated on 19.08.2018 ã. 09:46:57 from Type Library described below.
...
// *********************************************************************//
  ICFD_DUDEDisp = dispinterface
    ...
    function set_TCPIP(const IPAddress: WideString; Port: {??Word}OleVariant): Integer; dispid 253;
    ...
    property read_TimeOutValue: {??Word}OleVariant dispid 299;
...
// *********************************************************************//
  ICFD_DUDEEvents = dispinterface
    ...
    procedure OnError(error_Code: Integer; var error_Message: WideString); dispid 201;
    procedure OnBeforeScriptExecute; dispid 203;
    procedure OnFirstProgress_Init(value_Minimum: Integer; value_Maximum: Integer; 
                                   value_Position: Integer); dispid 204;
    procedure OnSecondProgress_Init(value_Minimum: Integer; value_Maximum: Integer; 
                                    value_Position: Integer); dispid 205;
    procedure OnFirstProgress_Loop(value_Position: Integer); dispid 206;
    procedure OnSecondProgress_Loop(value_Position: Integer); dispid 207;
    procedure OnFirstProgress_Complete; dispid 208;
    procedure OnSecondProgress_Complete; dispid 209;
    procedure OnWait(Value: Byte); dispid 210;
    procedure OnStatusChange; dispid 211;
    procedure OnSendCommand(var Command: WideString; var DateAndTime: WideString; 
                            var repeat_Value: WideString; var hex_Header: WideString; 
                            var hex_Data: WideString; var hex_Footer: WideString; 
                            var human_Data: WideString); dispid 212;
    procedure OnReceiveAnswer(var Command: WideString; var DateAndTime: WideString; 
                              var repeat_Value: WideString; var hex_Header: WideString; 
                              var hex_Data: WideString; var hex_Footer: WideString; 
                              var human_Data: WideString); dispid 213;
    procedure OnAfterScriptExecute; dispid 214;
    procedure OnScriptRowExecute(row_Index: Integer; error_Code: Integer; 
                                 var input_Value: WideString; var output_Value: WideString); dispid 202;
    procedure OnJETextData(var TextData: WideString); dispid 215;
    procedure OnAfterOpenConnection; dispid 216;
    procedure OnAfterCloseConnection; dispid 217;
    procedure OnAfterChangeSettings(settings_Index: Integer); dispid 218;
  end;
...
{$ENDIF}
  ...
  private
    ...
    FIntf:        ICFD_DUDE;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TCFD_DUDEProperties;
    function      GetServerProperties: TCFD_DUDEProperties;
{$ENDIF}
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TCFD_DUDEProperties read GetServerProperties;
{$ENDIF}
...
// *********************************************************************//
 TCFD_DUDEProperties = class(TPersistent)
  private
    FServer:    TCFD_DUDE;
    function    GetDefaultInterface: ICFD_DUDE;
    constructor Create(AServer: TCFD_DUDE);
  protected
    function Get_eSBit_GeneralError_Sharp: WordBool;
    function Get_eSBit_PrintingMechanism: WordBool;
    function Get_eSBit_ClockIsNotSynchronized: WordBool;
...
resourcestring
  dtlServerPage = 'FP_DEVICES';

  dtlOcxPage = 'FP_DEVICES';
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TCFD_DUDEProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TCFD_DUDE.GetServerProperties: TCFD_DUDEProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
begin
  DefaultInterface.Set_language(Value);
end;
...
begin
  DefaultInterface.Set_zRange_StartValue(Value);
end;
...
begin
  DefaultInterface.Set_zRange_EndValue(Value);
end;
...
procedure TCFD_DUDE.Set_DateRange_StartValue(const Value: WideString);
  { Warning: The property DateRange_StartValue has a setter and a getter whose
...
begin
  ...
  InterfaceVariant.DateRange_StartValue := Value;
end;
...
procedure TCFD_DUDE.Set_DateRange_EndValue(const Value: WideString);
  { Warning: The property DateRange_EndValue has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.DateRange_EndValue := Value;
end;
...
begin
  DefaultInterface.Set_rs232_OnOpen_Set_DCB(Value);
end;
...
begin
  DefaultInterface.Set_rs232_OnOpen_Set_DTR_ToFalse(Value);
end;
...
begin
  DefaultInterface.Set_rs232_OnOpen_Set_RTS_ToFalse(Value);
end;
...
begin
  DefaultInterface.Set_exit_ByReadTimeOutIsOn(Value);
end;
...
begin
  DefaultInterface.Set_read_TimeOutValue(Value);
end;
...
begin
  DefaultInterface.Set_DocumentNumber_StartValue(Value);
end;
...
begin
  DefaultInterface.Set_DocumentNumber_EndValue(Value);
end;
...
begin
  DefaultInterface.Set_JEDocumentType(Value);
end;
...
begin
  DefaultInterface.Set_checkDeviceStatusOnCheckConnection(Value);
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TCFD_DUDEProperties.Create(AServer: TCFD_DUDE);
begin
  inherited Create;
  FServer := AServer;
end;

function TCFD_DUDEProperties.GetDefaultInterface: ICFD_DUDE;
begin
  Result := FServer.DefaultInterface;
end;

function TCFD_DUDEProperties.Get_eSBit_GeneralError_Sharp: WordBool;
begin
    Result := DefaultInterface.eSBit_GeneralError_Sharp;
end;

function TCFD_DUDEProperties.Get_eSBit_PrintingMechanism: WordBool;
begin
    Result := DefaultInterface.eSBit_PrintingMechanism;
end;

function TCFD_DUDEProperties.Get_eSBit_ClockIsNotSynchronized: WordBool;
begin
    Result := DefaultInterface.eSBit_ClockIsNotSynchronized;
end;

function TCFD_DUDEProperties.Get_eSBit_CommandCodeIsInvalid: WordBool;
begin
    Result := DefaultInterface.eSBit_CommandCodeIsInvalid;
end;

function TCFD_DUDEProperties.Get_eSBit_SyntaxError: WordBool;
begin
    Result := DefaultInterface.eSBit_SyntaxError;
end;

function TCFD_DUDEProperties.Get_eSBit_CommandNotPermitted: WordBool;
begin
    Result := DefaultInterface.eSBit_CommandNotPermitted;
end;

function TCFD_DUDEProperties.Get_eSBit_Overflow: WordBool;
begin
    Result := DefaultInterface.eSBit_Overflow;
end;

function TCFD_DUDEProperties.Get_eSBit_EJIsFull: WordBool;
begin
    Result := DefaultInterface.eSBit_EJIsFull;
end;

function TCFD_DUDEProperties.Get_eSBit_EndOfPaper: WordBool;
begin
    Result := DefaultInterface.eSBit_EndOfPaper;
end;

function TCFD_DUDEProperties.Get_eSBit_FM_NotFound: WordBool;
begin
    Result := DefaultInterface.eSBit_FM_NotFound;
end;

function TCFD_DUDEProperties.Get_eSBit_FM_NotAccess: WordBool;
begin
    Result := DefaultInterface.eSBit_FM_NotAccess;
end;

function TCFD_DUDEProperties.Get_eSBit_FM_Full: WordBool;
begin
    Result := DefaultInterface.eSBit_FM_Full;
end;

function TCFD_DUDEProperties.Get_eSBit_GeneralError_Star: WordBool;
begin
    Result := DefaultInterface.eSBit_GeneralError_Star;
end;

function TCFD_DUDEProperties.Get_iSBit_Cover_IsOpen: WordBool;
begin
    Result := DefaultInterface.iSBit_Cover_IsOpen;
end;

function TCFD_DUDEProperties.Get_iSBit_No_ClientDisplay: WordBool;
begin
    Result := DefaultInterface.iSBit_No_ClientDisplay;
end;

function TCFD_DUDEProperties.Get_iSBit_24h_AfterDayOpening: WordBool;
begin
    Result := DefaultInterface.iSBit_24h_AfterDayOpening;
end;

function TCFD_DUDEProperties.Get_iSBit_Receipt_Nonfiscal: WordBool;
begin
    Result := DefaultInterface.iSBit_Receipt_Nonfiscal;
end;

function TCFD_DUDEProperties.Get_iSBit_EJ_NearlyFull: WordBool;
begin
    Result := DefaultInterface.iSBit_EJ_NearlyFull;
end;

function TCFD_DUDEProperties.Get_iSBit_Receipt_Fiscal: WordBool;
begin
    Result := DefaultInterface.iSBit_Receipt_Fiscal;
end;

function TCFD_DUDEProperties.Get_iSBit_Near_PaperEnd: WordBool;
begin
    Result := DefaultInterface.iSBit_Near_PaperEnd;
end;

function TCFD_DUDEProperties.Get_iSBit_LessThan_60_Reports: WordBool;
begin
    Result := DefaultInterface.iSBit_LessThan_60_Reports;
end;

function TCFD_DUDEProperties.Get_iSBit_Number_SFM_Set: WordBool;
begin
    Result := DefaultInterface.iSBit_Number_SFM_Set;
end;

function TCFD_DUDEProperties.Get_iSBit_Number_Tax_Set: WordBool;
begin
    Result := DefaultInterface.iSBit_Number_Tax_Set;
end;

function TCFD_DUDEProperties.Get_iSBit_VAT_Set: WordBool;
begin
    Result := DefaultInterface.iSBit_VAT_Set;
end;

function TCFD_DUDEProperties.Get_iSBit_Device_Fiscalized: WordBool;
begin
    Result := DefaultInterface.iSBit_Device_Fiscalized;
end;

function TCFD_DUDEProperties.Get_iSBit_FM_Formated: WordBool;
begin
    Result := DefaultInterface.iSBit_FM_Formated;
end;

function TCFD_DUDEProperties.Get_language: TDudeLanguage;
begin
    Result := DefaultInterface.language;
end;

procedure TCFD_DUDEProperties.Set_language(Value: TDudeLanguage);
begin
  DefaultInterface.Set_language(Value);
end;

function TCFD_DUDEProperties.Get_connected_ToDevice: WordBool;
begin
    Result := DefaultInterface.connected_ToDevice;
end;

function TCFD_DUDEProperties.Get_connected_ToLAN: WordBool;
begin
    Result := DefaultInterface.connected_ToLAN;
end;

function TCFD_DUDEProperties.Get_lastError_Code: Integer;
begin
    Result := DefaultInterface.lastError_Code;
end;

function TCFD_DUDEProperties.Get_lastError_Message: WideString;
begin
    Result := DefaultInterface.lastError_Message;
end;

function TCFD_DUDEProperties.Get_codePage: LongWord;
begin
    Result := DefaultInterface.codePage;
end;

function TCFD_DUDEProperties.Get_support_RS232: WordBool;
begin
    Result := DefaultInterface.support_RS232;
end;

function TCFD_DUDEProperties.Get_support_TCPIP: WordBool;
begin
    Result := DefaultInterface.support_TCPIP;
end;

function TCFD_DUDEProperties.Get_rs232_ComPort: Integer;
begin
    Result := DefaultInterface.rs232_ComPort;
end;

function TCFD_DUDEProperties.Get_rs232_BaudRate: Integer;
begin
    Result := DefaultInterface.rs232_BaudRate;
end;

function TCFD_DUDEProperties.Get_tcpip_Address: WideString;
begin
    Result := DefaultInterface.tcpip_Address;
end;

function TCFD_DUDEProperties.Get_tcpip_Port: Integer;
begin
    Result := DefaultInterface.tcpip_Port;
end;

function TCFD_DUDEProperties.Get_trackingMode: WordBool;
begin
    Result := DefaultInterface.trackingMode;
end;

function TCFD_DUDEProperties.Get_trackingMode_Path: WideString;
begin
    Result := DefaultInterface.trackingMode_Path;
end;

function TCFD_DUDEProperties.Get_trackingMode_FileName: WideString;
begin
    Result := DefaultInterface.trackingMode_FileName;
end;

function TCFD_DUDEProperties.Get_trackingMode_RowLimit: Integer;
begin
    Result := DefaultInterface.trackingMode_RowLimit;
end;

function TCFD_DUDEProperties.Get_protocol_TransportType: TTransportProtocol;
begin
    Result := DefaultInterface.protocol_TransportType;
end;

function TCFD_DUDEProperties.Get_device_Type: TDeviceType;
begin
    Result := DefaultInterface.device_Type;
end;

function TCFD_DUDEProperties.Get_device_Number_Serial: WideString;
begin
    Result := DefaultInterface.device_Number_Serial;
end;

function TCFD_DUDEProperties.Get_device_Number_FMemory: WideString;
begin
    Result := DefaultInterface.device_Number_FMemory;
end;

function TCFD_DUDEProperties.Get_device_Distributor: WideString;
begin
    Result := DefaultInterface.device_Distributor;
end;

function TCFD_DUDEProperties.Get_device_Firmware_Revision: WideString;
begin
    Result := DefaultInterface.device_Firmware_Revision;
end;

function TCFD_DUDEProperties.Get_device_Firmware_Date: WideString;
begin
    Result := DefaultInterface.device_Firmware_Date;
end;

function TCFD_DUDEProperties.Get_device_Firmware_CheckSum: WideString;
begin
    Result := DefaultInterface.device_Firmware_CheckSum;
end;

function TCFD_DUDEProperties.Get_device_Model: TDeviceModel;
begin
    Result := DefaultInterface.device_Model;
end;

function TCFD_DUDEProperties.Get_device_Model_Name: WideString;
begin
    Result := DefaultInterface.device_Model_Name;
end;

function TCFD_DUDEProperties.Get_last_AnswerList: WideString;
begin
    Result := DefaultInterface.last_AnswerList;
end;

function TCFD_DUDEProperties.Get_download_Path: WideString;
begin
    Result := DefaultInterface.download_Path;
end;

function TCFD_DUDEProperties.Get_zRange_StartValue: Integer;
begin
    Result := DefaultInterface.zRange_StartValue;
end;

procedure TCFD_DUDEProperties.Set_zRange_StartValue(Value: Integer);
begin
  DefaultInterface.Set_zRange_StartValue(Value);
end;

function TCFD_DUDEProperties.Get_zRange_EndValue: Integer;
begin
    Result := DefaultInterface.zRange_EndValue;
end;

procedure TCFD_DUDEProperties.Set_zRange_EndValue(Value: Integer);
begin
  DefaultInterface.Set_zRange_EndValue(Value);
end;

function TCFD_DUDEProperties.Get_DateRange_StartValue: WideString;
begin
    Result := DefaultInterface.DateRange_StartValue;
end;

procedure TCFD_DUDEProperties.Set_DateRange_StartValue(const Value: WideString);
  { Warning: The property DateRange_StartValue has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TCFD_DUDEProperties.Get_DateRange_EndValue: WideString;
begin
    Result := DefaultInterface.DateRange_EndValue;
end;

procedure TCFD_DUDEProperties.Set_DateRange_EndValue(const Value: WideString);
  { Warning: The property DateRange_EndValue has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TCFD_DUDEProperties.Get_rs232_ReadIntervalTimeout: LongWord;
begin
    Result := DefaultInterface.rs232_ReadIntervalTimeout;
end;

function TCFD_DUDEProperties.Get_rs232_ReadTotalTimeoutMultiplier: LongWord;
begin
    Result := DefaultInterface.rs232_ReadTotalTimeoutMultiplier;
end;

function TCFD_DUDEProperties.Get_rs232_ReadTotalTimeoutConstant: LongWord;
begin
    Result := DefaultInterface.rs232_ReadTotalTimeoutConstant;
end;

function TCFD_DUDEProperties.Get_rs232_WriteTotalTimeoutMultiplier: LongWord;
begin
    Result := DefaultInterface.rs232_WriteTotalTimeoutMultiplier;
end;

function TCFD_DUDEProperties.Get_rs232_WriteTotalTimeoutConstant: LongWord;
begin
    Result := DefaultInterface.rs232_WriteTotalTimeoutConstant;
end;

function TCFD_DUDEProperties.Get_rs232_OnOpen_Set_DCB: WordBool;
begin
    Result := DefaultInterface.rs232_OnOpen_Set_DCB;
end;

procedure TCFD_DUDEProperties.Set_rs232_OnOpen_Set_DCB(Value: WordBool);
begin
  DefaultInterface.Set_rs232_OnOpen_Set_DCB(Value);
end;

function TCFD_DUDEProperties.Get_rs232_OnOpen_Set_DTR_ToFalse: WordBool;
begin
    Result := DefaultInterface.rs232_OnOpen_Set_DTR_ToFalse;
end;

procedure TCFD_DUDEProperties.Set_rs232_OnOpen_Set_DTR_ToFalse(Value: WordBool);
begin
  DefaultInterface.Set_rs232_OnOpen_Set_DTR_ToFalse(Value);
end;

function TCFD_DUDEProperties.Get_rs232_OnOpen_Set_RTS_ToFalse: WordBool;
begin
    Result := DefaultInterface.rs232_OnOpen_Set_RTS_ToFalse;
end;

procedure TCFD_DUDEProperties.Set_rs232_OnOpen_Set_RTS_ToFalse(Value: WordBool);
begin
  DefaultInterface.Set_rs232_OnOpen_Set_RTS_ToFalse(Value);
end;

function TCFD_DUDEProperties.Get_exit_ByReadTimeOutIsOn: WordBool;
begin
    Result := DefaultInterface.exit_ByReadTimeOutIsOn;
end;

procedure TCFD_DUDEProperties.Set_exit_ByReadTimeOutIsOn(Value: WordBool);
begin
  DefaultInterface.Set_exit_ByReadTimeOutIsOn(Value);
end;

function TCFD_DUDEProperties.Get_read_TimeOutValue: Word;
begin
    Result := DefaultInterface.read_TimeOutValue;
end;

procedure TCFD_DUDEProperties.Set_read_TimeOutValue(Value: Word);
begin
  DefaultInterface.Set_read_TimeOutValue(Value);
end;

function TCFD_DUDEProperties.Get_active_OnBeforeScriptExecute: WordBool;
begin
    Result := DefaultInterface.active_OnBeforeScriptExecute;
end;

function TCFD_DUDEProperties.Get_active_OnScriptRowExecute: WordBool;
begin
    Result := DefaultInterface.active_OnScriptRowExecute;
end;

function TCFD_DUDEProperties.Get_active_OnAfterScriptExecute: WordBool;
begin
    Result := DefaultInterface.active_OnAfterScriptExecute;
end;

function TCFD_DUDEProperties.Get_active_OnFirstProgress_Init: WordBool;
begin
    Result := DefaultInterface.active_OnFirstProgress_Init;
end;

function TCFD_DUDEProperties.Get_active_OnFirstProgress_Loop: WordBool;
begin
    Result := DefaultInterface.active_OnFirstProgress_Loop;
end;

function TCFD_DUDEProperties.Get_active_OnFirstProgress_Complete: WordBool;
begin
    Result := DefaultInterface.active_OnFirstProgress_Complete;
end;

function TCFD_DUDEProperties.Get_active_OnSecondProgress_Init: WordBool;
begin
    Result := DefaultInterface.active_OnSecondProgress_Init;
end;

function TCFD_DUDEProperties.Get_active_OnSecondProgress_Loop: WordBool;
begin
    Result := DefaultInterface.active_OnSecondProgress_Loop;
end;

function TCFD_DUDEProperties.Get_active_OnSecondProgress_Complete: WordBool;
begin
    Result := DefaultInterface.active_OnSecondProgress_Complete;
end;

function TCFD_DUDEProperties.Get_active_OnSendCommand: WordBool;
begin
    Result := DefaultInterface.active_OnSendCommand;
end;

function TCFD_DUDEProperties.Get_active_OnWait: WordBool;
begin
    Result := DefaultInterface.active_OnWait;
end;

function TCFD_DUDEProperties.Get_active_OnReceiveAnswer: WordBool;
begin
    Result := DefaultInterface.active_OnReceiveAnswer;
end;

function TCFD_DUDEProperties.Get_active_OnStatusChange: WordBool;
begin
    Result := DefaultInterface.active_OnStatusChange;
end;

function TCFD_DUDEProperties.Get_active_OnError: WordBool;
begin
    Result := DefaultInterface.active_OnError;
end;

function TCFD_DUDEProperties.Get_DocumentNumber_StartValue: Integer;
begin
    Result := DefaultInterface.DocumentNumber_StartValue;
end;

procedure TCFD_DUDEProperties.Set_DocumentNumber_StartValue(Value: Integer);
begin
  DefaultInterface.Set_DocumentNumber_StartValue(Value);
end;

function TCFD_DUDEProperties.Get_DocumentNumber_EndValue: Integer;
begin
    Result := DefaultInterface.DocumentNumber_EndValue;
end;

procedure TCFD_DUDEProperties.Set_DocumentNumber_EndValue(Value: Integer);
begin
  DefaultInterface.Set_DocumentNumber_EndValue(Value);
end;

function TCFD_DUDEProperties.Get_JEDocumentType: TDocumentTypes;
begin
    Result := DefaultInterface.JEDocumentType;
end;

procedure TCFD_DUDEProperties.Set_JEDocumentType(Value: TDocumentTypes);
begin
  DefaultInterface.Set_JEDocumentType(Value);
end;

function TCFD_DUDEProperties.Get_ExchangePrinter: WordBool;
begin
    Result := DefaultInterface.ExchangePrinter;
end;

function TCFD_DUDEProperties.Get_active_OnAfterCloseConnection: WordBool;
begin
    Result := DefaultInterface.active_OnAfterCloseConnection;
end;

function TCFD_DUDEProperties.Get_active_OnAfterOpenConnection: WordBool;
begin
    Result := DefaultInterface.active_OnAfterOpenConnection;
end;

function TCFD_DUDEProperties.Get_register_ActiveObject_OnStart: WordBool;
begin
    Result := DefaultInterface.register_ActiveObject_OnStart;
end;

function TCFD_DUDEProperties.Get_active_OnAfterSettingsChange: WordBool;
begin
    Result := DefaultInterface.active_OnAfterSettingsChange;
end;

function TCFD_DUDEProperties.Get_save_SettingsAfterOpenConnection: WordBool;
begin
    Result := DefaultInterface.save_SettingsAfterOpenConnection;
end;

function TCFD_DUDEProperties.Get_checkDeviceStatusOnCheckConnection: WordBool;
begin
    Result := DefaultInterface.checkDeviceStatusOnCheckConnection;
end;

procedure TCFD_DUDEProperties.Set_checkDeviceStatusOnCheckConnection(Value: WordBool);
begin
  DefaultInterface.Set_checkDeviceStatusOnCheckConnection(Value);
end;
